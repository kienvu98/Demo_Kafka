...
import com.microservices.demo.security.AnalyticsUserDetailService;
import com.microservices.demo.security.AnalyticsUserJwtConverter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public WebSecurityConfig(OAuth2ResourceServerProperties oAuth2ResourceServerProperties,
                             AnalyticsUserDetailService analyticsUserDetailService) {
    ...
    Converter<Jwt, ? extends AbstractAuthenticationToken> analyticsUserJwtConverter() {
        return new AnalyticsUserJwtConverter(analyticsUserDetailService);
    }
