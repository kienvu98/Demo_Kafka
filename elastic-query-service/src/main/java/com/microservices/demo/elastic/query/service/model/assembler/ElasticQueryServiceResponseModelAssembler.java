...
public class ElasticQueryServiceResponseModelAssembler extends
    ...
    private final ElasticToResponseModelTransformer elsElasticToResponseModelTransformer;
    ...
    public ElasticQueryServiceResponseModelAssembler(ElasticToResponseModelTransformer transformer) {
        ...
        this.elsElasticToResponseModelTransformer = transformer;
    }

    //  hatoes
    @Override
    public ElasticQueryServiceResponseModel toModel(TwitterIndexModel twitterIndexModel) {
        ElasticQueryServiceResponseModel responseModel = elsElasticToResponseModelTransformer.getResponseModel(twitterIndexModel);
        responseModel.add(
