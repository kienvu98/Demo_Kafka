...
import static com.microservices.demo.kafka.services.Constants.NA;
...
public class KafkaStreamsUserJwtConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public KafkaStreamsUserJwtConverter(KafkaStreamsUserDetailService kafkaStreamsUserDetailService) {
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        ...
        return Optional.ofNullable(
                kafkaStreamsUserDetailService.loadUserByUsername(jwt.getClaimAsString(USERNAME_CLAIM))).map(userDetails -> {
