...
public class QueryController {
    ...
    private final ElasticQueryWebClient elsElasticQueryWebClient;

    public QueryController(ElasticQueryWebClient webClient) {
        this.elsElasticQueryWebClient = webClient;
    }
    ...
    public String querybByText(@Valid ElasticQueryWebClientRequestModel requestModel, Model model){
        Flux<ElasticQueryWebClientResponseModel> responseModel = elsElasticQueryWebClient.getDatabyText(requestModel);
